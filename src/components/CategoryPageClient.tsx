...
export function CategoryPageClient({ category, projects, total }: CategoryPageClientProps) {
  return (
      ...
      <section className="bg-gradient-to-b from-accent-light to-white py-12 sm:py-16">
        <div className="max-w-content mx-auto px-4 sm:px-6">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">
            分类: <span className="text-accent">{category}</span>
          </h1>
          <p className="text-gray-600">
            共 {total} 个{category}项目
          </p>
        </div>
      </section>
      ...
      <section className="max-w-content mx-auto px-4 sm:px-6 py-8">
        {projects.length === 0 ? (
          <div className="text-center py-16">
            <p className="text-gray-500 text-lg mb-4">暂无此分类的项目</p>
            <Link
              href="/"
